...
Once you have installed the dependencies you will need to create the [navigation](/gatsby-starte-rocket-docs/usage/navigation) and [documentation](/gatsby-starter-rocket-docs/usage/creating-docs) file.
