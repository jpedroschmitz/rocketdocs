...
Once you have installed the dependencies you will need to create the [navigation](/gatsby-themes/usage/navigation) and [documentation](/gatsby-themes/usage/creating-docs) file.
